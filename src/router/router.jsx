...
const DashboardEventos = lazy(() => import("../pages/dashboard/eventos.jsx"));
const DashboardAgregarEvento = lazy(() => import("../pages/dashboard/agregarEvento.jsx"));
const DashboardEditarEvento = lazy(() => import("../pages/dashboard/editarEvento.jsx"));
